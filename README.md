...
8. Scroll down to file `home.cy.js` and `api_json_placeholder.cy.js`
...
9. If you want to run UI Automation then click file `home.cy.js`. For API Automation click file `api_json_placeholder.cy.js`.
